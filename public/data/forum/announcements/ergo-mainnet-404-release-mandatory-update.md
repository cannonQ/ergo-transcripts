---
title: Ergo Mainnet 4.0.4 Release - MANDATORY UPDATE!
description: 'ErgoForum discussion: Ergo Mainnet 4.0.4 Release - MANDATORY UPDATE!'
tags:
- announcements
- autolykos
...
source: ergoforum
source_url: https://ergoforum.org/t/ergo-mainnet-4-0-4-release-mandatory-update/598
created: '2021-02-02'
last_activity: '2021-02-02'
posts_count: 1
views: 903
likes: 1
glossary_hits:
...
# Ergo Mainnet 4.0.4 Release - MANDATORY UPDATE!

> **Forum thread:** [https://ergoforum.org/t/ergo-mainnet-4-0-4-release-mandatory-update/598](https://ergoforum.org/t/ergo-mainnet-4-0-4-release-mandatory-update/598)
> **Category:** Announcements | **Created:** 2021-02-02 | **Posts:** 1 | **Views:** 903

**Related concepts:** Autolykos, Difficulty adjustment, ErgoTree, Full node, Sigmastate interpreter, Soft fork, Transaction

---

### Post #1 — @Martin-mx (2021-02-02)

MANDATORY UPDATE!

This version contains fixes for protocol version 2 initial difficulty value and recalculation rule.

Below are protocol version 2 update notes.
...
[github.com](https://github.com/ergoplatform/ergo/releases/tag/v4.0.4)

![](https://avatars.githubusercontent.com/u/27490654?s=400&amp;v=4)

### [Release Ergo Protocol Reference Client 4.0.4 · ergoplatform/ergo](https://github.com/ergoplatform/ergo/releases/tag/v4.0.4)

[s/tag/v4.0.4](https://github.com/ergoplatform/ergo/releases/tag/v4.0.4)

MANDATORY UPDATE!
This version contains fixes for protocol version 2 initial difficulty value and recalculation rule.
Below are protocol version 2 update notes.
Major changes
Autolykos 2 PoW schem...
