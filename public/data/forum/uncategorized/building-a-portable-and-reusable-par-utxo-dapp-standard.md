---
title: Building A Portable And Reusable (PaR) UTXO dApp Standard
description: 'ErgoForum discussion: Building A Portable And Reusable (PaR) UTXO dApp
  Standard'
tags:
- box
- eip
...
source: ergoforum
source_url: https://ergoforum.org/t/building-a-portable-and-reusable-par-utxo-dapp-standard/441
created: '2020-10-27'
last_activity: '2020-10-27'
posts_count: 2
views: 711
likes: 6
glossary_hits:
...
> **Forum thread:** [https://ergoforum.org/t/building-a-portable-and-reusable-par-utxo-dapp-standard/441](https://ergoforum.org/t/building-a-portable-and-reusable-par-utxo-dapp-standard/441)
> **Category:** Uncategorized | **Created:** 2020-10-27 | **Posts:** 2 | **Views:** 711

**Related concepts:** Box, EIP, EIP-6, Ergo Explorer, ErgoScript, ErgoScript context, Full node, sigma-rust

---

### Post #1 — @robert (2020-10-27)
...
Today we have Rust Ergo-Lib(aka. sigma-rust), a great library that is being developed by [@greenden](/u/greenden) which provides us with the vast majority of tools we need for writing off-chain dApp code. Furthermore, Ergo-Lib already has WASM bindings, with mobile bindings in the works as well. What this means is that off-chain dApp code we write in Rust is reusable for effectively every target we desire.
...
### Post #2 — @kushti (2020-10-27)

Sounds really awesome!

Also, we can standardize some scans, e.g. DEX-related. Then we can have public nodes providing standard scans (voluntarily, or by getting some rewards for that).
