---
title: Registers and types
description: 'ErgoForum discussion: Registers and types'
tags:
- ergoforum
- ergoscript
- ergoscript-context
...
source: ergoforum
source_url: https://ergoforum.org/t/registers-and-types/220
created: '2020-05-19'
last_activity: '2020-05-19'
posts_count: 1
views: 777
likes: 2
glossary_hits:
...
> **Forum thread:** [https://ergoforum.org/t/registers-and-types/220](https://ergoforum.org/t/registers-and-types/220)
> **Category:** Uncategorized | **Created:** 2020-05-19 | **Posts:** 1 | **Views:** 777

**Related concepts:** ErgoScript, ErgoScript context, ErgoTree, Registers

---

### Post #1 — @kushti (2020-05-19)

By [@morphic](/u/morphic) with very minor edits of mine:
