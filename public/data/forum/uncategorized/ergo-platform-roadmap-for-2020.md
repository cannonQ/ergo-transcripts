...
description: 'ErgoForum discussion: Ergo Platform Roadmap for 2020'
tags:
- atomic-swaps
- bootstrapping
- box
...
source: ergoforum
source_url: https://ergoforum.org/t/ergo-platform-roadmap-for-2020/180
created: '2020-02-02'
last_activity: '2020-02-02'
posts_count: 1
views: 894
likes: 2
glossary_hits:
...
> **Forum thread:** [https://ergoforum.org/t/ergo-platform-roadmap-for-2020/180](https://ergoforum.org/t/ergo-platform-roadmap-for-2020/180)
> **Category:** Uncategorized | **Created:** 2020-02-02 | **Posts:** 1 | **Views:** 894

**Related concepts:** Atomic swaps, Bootstrapping, Box, Collateral, EIP, Ergo Foundation, ErgoScript context, Full node, Kiosk, Ring signatures

---

### Post #1 — @Martin-mx (2020-02-02)
...
* First crowdfunding campaign ([Simple Crowdfunding](https://www.ergoforum.org/t/simple-crowdfunding/70)) and mixing ([Lets play with ErgoMix](https://www.ergoforum.org/t/lets-play-with-ergomix/108)) done!
...
With this minimum set of tools we will be ready to have more in 2021: mutual credit systems, p2p loan contracts, bonds, algorithmic stablecoins etc. However, this things could be implemented right now, so please join the ecosystem and build for it! Also, in 2021 we can get the “Universal dApp Interface & Package Standard” ([Universal dApp Interface & Package Standard](https://www.ergoforum.org/t/universal-dapp-interface-package-standard/153)) implemented, which could be a real game-changer in the dApp industry!
