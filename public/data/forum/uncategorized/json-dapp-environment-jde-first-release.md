---
title: JSON dApp Environment (JDE) first release
description: 'ErgoForum discussion: JSON dApp Environment (JDE) first release'
tags:
- addresses
- box
- ergoforum
...
source: ergoforum
source_url: https://ergoforum.org/t/json-dapp-environment-jde-first-release/1373
created: '2021-05-21'
last_activity: '2021-05-21'
posts_count: 1
views: 1600
likes: 4
glossary_hits:
...
> **Forum thread:** [https://ergoforum.org/t/json-dapp-environment-jde-first-release/1373](https://ergoforum.org/t/json-dapp-environment-jde-first-release/1373)
> **Category:** Uncategorized | **Created:** 2021-05-21 | **Posts:** 1 | **Views:** 1600

**Related concepts:** Addresses, Box, ErgoMixer, ErgoScript, ErgoScript context, Full node, Kiosk, Native tokens, Oracle pools, Registers, SigmaUSD, Transaction, sigma-rust

---

### Post #1 — @scalahub (2021-05-21)

## Introduction

This is to announce the first release of JSON dApp Environment (JDE), a tool for interacting with the Ergo blockchain.

[github.com](https://github.com/ergoplatform/ergo-jde)

![](https://ergoforum.org/uploads/default/optimized/2X/c/c43997e4e58c4d9dc8c7200b242bbe84297665f0_2_690x344.png)

### [GitHub - ergoplatform/ergo-jde: Ergo transaction builder using JSON](https://github.com/ergoplatform/ergo-jde)
