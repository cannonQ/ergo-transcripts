---
title: Efficient Global Context Claims & Accumulators In Blockchains
description: 'ErgoForum discussion: Efficient Global Context Claims & Accumulators
  In Blockchains'
tags:
- addresses
- amm
...
source: ergoforum
source_url: https://ergoforum.org/t/efficient-global-context-claims-accumulators-in-blockchains/211
created: '2020-05-09'
...
> **Forum thread:** [https://ergoforum.org/t/efficient-global-context-claims-accumulators-in-blockchains/211](https://ergoforum.org/t/efficient-global-context-claims-accumulators-in-blockchains/211)
> **Category:** Uncategorized | **Created:** 2020-05-09 | **Posts:** 4 | **Views:** 1213

**Related concepts:** AMM, Addresses, Box, Collateral, ErgoScript context, Full node, Liquidation, Native tokens, Registers, Transaction

---

### Post #1 — @robert (2020-05-09)

Recently I have been working through designing various DeFi protocols in the Ergo contract model, and the thought came to mind that to make things more efficient it would be of great benefit if we could make claims about the global state of the blockchain/UTXO-set. This lead me to come up with the concept of global context data accumulation (which I will explain in a moment) however I didn’t realize that the concept is even further extendable to any claim about the blockchain state until a conversation with [@jasondavies](/u/jasondavies) and [@scalahub](/u/scalahub) where they pointed out negative proofs are possible.
...
### Post #4 — @kushti (2020-09-10)

Global context claims can be useful for continuous token offerings also, so protocol metrics accumulated (if they are good enough) can be used to unlock a new portion of tokens.

---

### Post #5 — @robert (2020-09-11)

Great point [@kushti](/u/kushti). And in that use case, the people who have an incentive to unlock a new portion of tokens are the ones who can go and scan the blockchain and create the global context claim txs.
