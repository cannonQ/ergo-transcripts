...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2022-02-03-ergohack-iii-is-next-week
glossary_hits:
- Box
- DeCo Education
- ERGOHACK
...
> **Published:** 2022-02-03 | **Author:** Ergo Foundation | **Tag:** Events | **Type:** blog

**Related concepts:** Box, DeCo Education, ERGOHACK, EXLE, ErgoPad, ErgoRaffle, ErgoScript, IDO, Oracle pools, Spectrum, eUTXO
...
4. **ErgoPad:** This project started as a simple framework for tracking native Ergo assets and now has developed into the [first launch pad on the Ergo](https://ergoplatform.org/blog/2021-12-14-ergopad-ergos-first-ido-platform/) blockchain. The platform aims to provide a flexible alternative for new projects looking to launch initial DEX offerings on Ergo. 
