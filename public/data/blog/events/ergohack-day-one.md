...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-06-12-ergohack-day-one
glossary_hits:
- Box
- Collateral
- ERGOHACK
...
> **Published:** 2021-06-12 | **Author:** Curia Regis Crypto | **Tag:** Events | **Type:** blog

**Related concepts:** Box, Collateral, ERGOHACK, ErgoScript, SigmaUSD, Spectrum, eUTXO
...
Team SmartPools is diving into [Ergo’s Oracle solution](https://ergoplatform.org/blog/2020-08-31-ergos-oracle-pools-and-what-they-mean-for-the-ecosystem/) in a quest for building smart contracts that seek to gather collateral with current fundraising functionality, determining the hashing weight of the pools for each other and the network. This idea is lucrative in the redistributing of a defined excess in rewards for the fundraising contracts of similar pools.
