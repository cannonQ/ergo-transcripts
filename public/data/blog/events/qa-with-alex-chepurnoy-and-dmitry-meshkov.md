...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2019_03_19-Q&A
glossary_hits:
- AVL tree
- Addresses
- Box
...
# Q&A with Alex Chepurnoy and Dmitry Meshkov

> **Published:** 2019-03-19 | **Author:** Dmitry Meshkov | **Tag:** Events | **Type:** blog

**Related concepts:** AVL tree, Addresses, Box, ErgoScript, Full node, Mempool, Minimum transaction fee, Native tokens, SPV, Sigma Chains, Storage rent, Transaction
