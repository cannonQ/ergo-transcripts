...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2020_06_11_emurgo_ergo
glossary_hits:
- Box
- ErgoScript
- NiPoPoW
...
> **Published:** 2020-06-11 | **Author:** Guy Brandon | **Tag:** Events | **Type:** blog

**Related concepts:** Box, ErgoScript, NiPoPoW, Scorex, Transaction, eUTXO
...
The recent [partnership announced between Emurgo and Ergo](https://ergoplatform.org/blog/2020_06_09_press_release/) has been positively received by both communities. For good reason: this is an exceptional opportunity to pool resources into an important and emerging area of research, while allowing both projects to use the insights gained in their own ways and for their own roadmaps. 
...
Where they overlap, and the most promising area for collaboration, is in their use of the extended UTXO model. (You can read [more about Ergo’s use of UTXOs here](https://ergoplatform.org/blog/2020_03_03_building_utxo/).)
...
A great example of this is the Yoroi wallet, which will become a kind of MetaMask for engaging with Ergo-based dApps as well as the Cardano ecosystem. Meanwhile, features that Ergo has already implemented ([such as NiPoPoW](https://ergoplatform.org/blog/2020_05_1_spv_security/)) and will implement in the future offer a precedent for Cardano and other blockchains, even if those features cannot directly be imported.
