...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-09-26-the-utxo-alliance
glossary_hits:
- AMM
- Box
- Collateral
...
> **Published:** 2021-09-26 | **Author:** Glasgow | **Tag:** Announcements | **Type:** blog

**Related concepts:** AMM, Box, Collateral, Data input, Ergo Foundation, ErgoMixer, ErgoScript context, Multi-stage contracts, Native tokens, NiPoPoW, Oracle pools, Scorex, Sigma protocols, SigmaUSD, Spectrum, Transaction, eUTXO
...
* [Chainlink Oracles vs Ergo Oracle Pools](https://ergoplatform.org/blog/2021-04-27-chainlink-oracles-vs-ergo-oracle-pools/)
...
Using the knowledge he amassed across these projects, Alex shifted his focus from IOHK and Cardano to designing a truly fair PoW that would be uniquely useful as contractual money. Read [The Ergo Manifesto](https://ergoplatform.org/blog/2021-04-26-the-ergo-manifesto/) for more information.
