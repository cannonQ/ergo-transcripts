...
- transaction
category: blog
blog_tag: Announcements, Events
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-05-13-bearwhale-saga
glossary_hits:
- Addresses
- Auction House
- Box
...
> **Published:** 2021-05-13 | **Author:** Glasgow | **Tag:** Announcements, Events | **Type:** blog

**Related concepts:** Addresses, Auction House, Box, Collateral, Ergo Explorer, Ergo Foundation, ErgoMixer, Liquidation, MEV, Native tokens, Oracle pools, SigmaUSD, Spectrum, Transaction
...
Read the full blog post regarding this on the blog: [Finding The Right Balance](https://ergoplatform.org/blog/2021_03_04-finding-right-balance/).
