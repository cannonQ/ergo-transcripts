---
title: Ledger Integration begins
date: '2021-05-07'
...
- transaction
category: blog
blog_tag: Announcements, Tooling
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-05-07-ledger-network-integrates-ergo-network
glossary_hits:
- Native tokens
- Oracle pools
- Sigma protocols
...
> **Published:** 2021-05-07 | **Author:** Ergo Foundation | **Tag:** Announcements, Tooling | **Type:** blog

**Related concepts:** Native tokens, Oracle pools, Sigma protocols, SigmaUSD, Transaction
...
ERGOs [Sigma protocols](https://ergoplatform.org/blog/2020_03_16_ergo_sigma/) and blockchain architecture allow for what otherwise would be very difficult in conventional smart contract platforms. The use cases for financial contracts are endless, including the issuance of decentralized [stablecoins](https://ergoplatform.org/blog/2021-02-05-building-ergo-how-the-ageusd-stablecoin-works/), [NFTs](https://ergoplatform.org/blog/2020-10-16-announcing-the-auction-house-nft-marketplace-on-ergo/), [Oracle pools](https://ergoplatform.org/blog/2020-08-31-ergos-oracle-pools-and-what-they-mean-for-the-ecosystem/), and [decentralized mixers](https://ergoplatform.org/blog/2020_03_20_ergo_mixer/), among many other things.

You can read Ergo’s Manifesto [here](https://ergoplatform.org/blog/2021-04-26-the-ergo-manifesto/)
