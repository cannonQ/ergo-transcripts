...
- transaction
category: blog
blog_tag: Basics, Tooling
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-10-07-utxo-model-transaction
glossary_hits:
- Addresses
- Auction House
- Box
...
> **Published:** 2021-10-07 | **Author:** Ergo Platform | **Tag:** Basics, Tooling | **Type:** blog

**Related concepts:** Addresses, Auction House, Box, Ergo Explorer, ErgoScript, Native tokens, SigmaUSD, Spectrum, Transaction
...
*For an in-depth comparison about UTXO and Accounts models, please read our previous blog post:* [Ergo: Advancing on Bitcoin](https://ergoplatform.org/blog/2021-08-17-ergo-advancing-on-bitcoin/)
