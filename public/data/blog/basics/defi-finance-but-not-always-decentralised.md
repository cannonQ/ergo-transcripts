...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2020-09-17-defi-finance-but-not-always-decentralised
glossary_hits:
- Full node
- Native tokens
- Spectrum
...
> **Published:** 2020-09-17 | **Author:** Guy Brandon | **Tag:** Basics | **Type:** blog

**Related concepts:** Full node, Native tokens, Spectrum

---

As a recent blog post explored, [DeFi – decentralised finance – can and will be used in whatever ways developers and the market see fit](https://ergoplatform.org/blog/2020-09-03-some-thoughts-about-defi-yield-farming-and-how-open-systems-should-be-used/). This is the nature of open, decentralised systems. You can’t stop it, and there’s a very strong argument for saying we shouldn’t try. To restrict any element of DeFi, at least at the protocol level, is to introduce centralisation and single points of failure, thereby killing the core innovation by misguidedly trying to protect it.
