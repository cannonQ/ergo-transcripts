...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2020-10-09-yoroi-your-gateway-to-ergo-dapps
glossary_hits:
- Addresses
- Box
- ErgoMixer
...
> **Published:** 2020-10-09 | **Author:** Guy Brandon | **Tag:** Tooling | **Type:** blog

**Related concepts:** Addresses, Box, ErgoMixer, ErgoScript, Native tokens, Sigma protocols, Transaction
...
![](/img/uploads/tw22.jpg "https://twitter.com/YoroiWallet/status/1314244618435739648")
...
As we have explored on the blog, though, Ergo takes a very different approach to smart contracts, with its extended-UTXO model. Implementation of [Sigma Protocols](https://ergoplatform.org/blog/2020_03_16_ergo_sigma/) enables use cases that would be impractical or impossible to develop on Ethereum. We already have the first of these applications up and running, such as the [efficient, trustless ErgoMixer](https://ergoplatform.org/blog/2020_03_20_ergo_mixer/) and [zero-knowledge digital signature app, ZKTreasury](https://ergoplatform.org/blog/2020-09-04-announcing-the-zk-treasury-on-ergo/).

Yoroi will enable developers to build web dApps with seamless user interfaces for many use cases such as [decentralised exchanges](https://ergoplatform.org/blog/2020-07-31-decentralized-exchange-contracts-on-ergo/), token-based projects ([including NFTs](https://ergoplatform.org/blog/2020-09-25-nfts-on-ergo/)), and other key applications, such as stablecoins.
