---
title: 'Babel Fees on Ergo: How-To Guide
...
- transaction
category: blog
blog_tag: Tooling, Core
type: blog
source: ergo-blog
source_url: 'https://ergoplatform.org/en/blog/Babel Fees on Ergo: How-To Guide'
glossary_hits:
- Box
- EIP-31
- ErgoPay
...
> **Published:** 2022-11-24 | **Author:** Ergo Platform | **Tag:** Tooling, Core | **Type:** blog

**Related concepts:** Box, EIP-31, ErgoPay, Native tokens, Nautilus, SigmaUSD, Token ID rule, TokenJay, Transaction
