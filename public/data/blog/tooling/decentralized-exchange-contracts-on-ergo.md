...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2020-07-31-decentralized-exchange-contracts-on-ergo
glossary_hits:
- Box
- ErgoScript context
- Native tokens
...
> **Published:** 2020-07-31 | **Author:** Denys Zadorozhnyi | **Tag:** Tooling | **Type:** blog

**Related concepts:** Box, ErgoScript context, Native tokens, Registers, Transaction
