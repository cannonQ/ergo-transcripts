...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2019_12_31_ergo_tool
glossary_hits:
- Addresses
- AppKit
- Box
...
> **Published:** 2019-12-31 | **Author:** Alexander Slesarenko | **Tag:** Tooling | **Type:** blog

**Related concepts:** Addresses, AppKit, Box, Constant segregation, Ergo Explorer, ErgoScript, ErgoScript context, ErgoTree, Full node, Sigma protocols, Transaction
