...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2020-12-11-ergo-bootstrap-streamlining-ergo-dapp-infrastructure-with-one-simple-tool
glossary_hits:
- Ergo Explorer
- Ergo Foundation
- Full node
...
# Ergo Bootstrap, Streamlining Ergo dApp Infrastructure With One Simple Tool

> **Published:** 2020-12-11 | **Author:** Robert Kornacki | **Tag:** Tooling | **Type:** blog

**Related concepts:** Ergo Explorer, Ergo Foundation, Full node, Mempool, Native tokens, Transaction
