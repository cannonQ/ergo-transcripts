...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2020_04_29_flow_cards
glossary_hits:
- Addresses
- AppKit
- Box
...
> **Published:** 2020-04-29 | **Author:** Alexander Slesarenko | **Tag:** Tooling | **Type:** blog

**Related concepts:** Addresses, AppKit, Box, EIP, ErgoScript, ErgoScript context, ErgoTree, FlowCards, Full node, Minimum transaction fee, Native tokens, Registers, Sigma protocols, Spectrum, Token ID rule, Transaction
...
- [Introduction to Appkit](https://ergoplatform.org/blog/2019_12_03_top5/)
