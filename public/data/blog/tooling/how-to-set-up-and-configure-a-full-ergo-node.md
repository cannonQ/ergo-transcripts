...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2019_12_02_how_to_setup
glossary_hits:
- Addresses
- Box
- Context extension
...
> **Published:** 2019-12-02 | **Author:** Ergo Team | **Tag:** Tooling | **Type:** blog

**Related concepts:** Addresses, Box, Context extension, ErgoScript context, Full node, Native tokens, Node modes, Registers, Scorex, Transaction
