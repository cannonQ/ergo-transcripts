...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2019_07_24_ergo_address
glossary_hits:
- Addresses
- Box
- Native tokens
...
> **Published:** 2019-07-24 | **Author:** Robert Wolf | **Tag:** Tooling | **Type:** blog

**Related concepts:** Addresses, Box, Native tokens, Registers, Transaction
...
It is precisely one of these alphanumeric addresses that's needed to either send money from person A to person B, receive money or [withdraw your mining rewards](https://ergoplatform.org/blog/2019_07_03_mining_withdrawal/).
If you want to get started using the Ergo wallet and dive deeper into its functions go check out the [following link](https://ergoplatform.org/blog/2019_06_04_wallet-documentation/).
