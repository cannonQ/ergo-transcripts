...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2022-02-22-defi-on-ergo-custom-token-fees
glossary_hits:
- Atomic swaps
- Box
- EIP-31
...
> **Published:** 2022-02-22 | **Author:** Ergo Platform | **Tag:** Tooling, Core | **Type:** blog

**Related concepts:** Atomic swaps, Box, EIP-31, ErgoMixer, Layer scaling, Native tokens, Transaction, ZeroJoin, eUTXO
