...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2020-10-12-learn-ergoscript-by-example
glossary_hits:
- Box
- Ergo Playgrounds
- ErgoMixer
...
# Learn ErgoScript by Example

> **Published:** 2020-10-12 | **Author:** Guy Brandon | **Tag:** Tooling | **Type:** blog

**Related concepts:** Box, Ergo Playgrounds, ErgoMixer, ErgoScript, Sigma protocols, eUTXO

---

*The new resources provide a powerful but simple way to learn UTXO-based smart contracts.*

Since its mainnet launch in July 2019, Ergo has steadily been building out both its core tech and its dapps ecosystem, with several unique developments in both. Ergo’s [Sigma Protocols](https://ergoplatform.org/blog/2020_03_16_ergo_sigma/) enable safe, customisable zero-knowledge proofs, which underpin such applications as [ErgoMixer](https://ergoplatform.org/blog/2020_03_20_ergo_mixer/) and the [ZKTreasury](https://ergoplatform.org/blog/2020-09-04-announcing-the-zk-treasury-on-ergo/). And there’s lots more to come!
