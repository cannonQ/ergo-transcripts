...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-12-02-ergo-blockchain-privacy-and-security
glossary_hits:
- Addresses
- Box
- ErgoMixer
...
# Ergo & Blockchain: Privacy and Security

> **Published:** 2021-12-02 | **Author:** Ergo Platform | **Tag:** Privacy | **Type:** blog

**Related concepts:** Addresses, Box, ErgoMixer, ErgoScript context, Native tokens, NiPoPoW, Sigma protocols, Transaction
...
Later, Bitcoin users could obfuscate their transactions through the use of centralized mixers. A non-interactive mixer was hard to implement on Bitcoin, although the [Taproot Upgrade](https://www.research.arcane.no/blog/what-is-taproot-the-next-bitcoin-upgrade) opens the possibility for newer privacy models. There are also privacy-oriented cryptocurrencies, such as Monero, that obfuscate all transactions. Ergo has the flexibility to implement privacy in various use cases. Although it is not a privacy-oriented blockchain, Sigma Protocols allow privacy-oriented dApps like [ErgoMixer](https://ergoplatform.org/blog/2021-05-12-ergomixer/), or private side-chains, to obfuscate specific transactions.
...
[Ergo & Blockchain: Cryptocurrency Sphere](https://ergoplatform.org/blog/2021-10-26-ergo-blockchain-cryptocurrency-sphere/) 

[Ergo & Blockchain: Tokenomics & Finance](https://ergoplatform.org/blog/2021-11-05-ergo-blockchain-tokenomics-and-finance/)
