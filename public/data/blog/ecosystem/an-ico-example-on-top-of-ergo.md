...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2019_04_10-ICO-example
glossary_hits:
- AVL tree
- Box
- Context extension
...
> **Published:** 2019-04-10 | **Author:** Alex Chepurnoy | **Tag:** Ecosystem, Tooling | **Type:** blog

**Related concepts:** AVL tree, Box, Context extension, ErgoScript, ErgoScript context, ErgoTree, Native tokens, Registers, Storage rent, Transaction
