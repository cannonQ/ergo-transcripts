...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2020-12-02-new-ergo-smart-dex-orders-with-buyback-guarantees
glossary_hits:
- Native tokens
- Spectrum
---

# New Ergo Smart DEX Orders with buyback guarantees

> **Published:** 2020-12-02 | **Author:** Guy Brandon | **Tag:** Ecosystem | **Type:** blog

**Related concepts:** Native tokens, Spectrum
