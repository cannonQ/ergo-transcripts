...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2019_04_22-LETS
glossary_hits:
- AVL tree
- Box
- Context extension
...
> **Published:** 2019-04-22 | **Author:** Alex Chepurnoy | **Tag:** Ecosystem | **Type:** blog

**Related concepts:** AVL tree, Box, Context extension, Data input, ErgoScript, ErgoScript context, Native tokens, Registers, Sigma protocols, Singleton / State NFT, Transaction
