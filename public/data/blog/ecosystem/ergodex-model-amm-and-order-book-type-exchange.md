...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-04-06-ergodex-model-amm-and-order-book-type-exchange
glossary_hits:
- AMM
- Atomic swaps
- Bootstrapping
...
# ErgoDEX Model - AMM and Order Book Type Exchange

> **Published:** 2021-04-06 | **Author:** root7Z | **Tag:** Ecosystem | **Type:** blog

**Related concepts:** AMM, Atomic swaps, Bootstrapping, Box, EIP, Native tokens, SigmaUSD, Spectrum, Transaction, eUTXO
...
<https://ergoplatform.org/blog/2020-12-02-new-ergo-smart-dex-orders-with-buyback-guarantees/>
