...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2020-10-16-announcing-the-auction-house-nft-marketplace-on-ergo
glossary_hits:
- Auction House
- Box
- Full node
...
# Announcing the Auction House, NFT Marketplace on Ergo

> **Published:** 2020-10-16 | **Author:** Guy Brandon | **Tag:** Ecosystem, NFTs | **Type:** blog

**Related concepts:** Auction House, Box, Full node, Native tokens, Transaction
...
[Ergo’s NFTs take a different approach](https://ergoplatform.org/blog/2020-09-25-nfts-on-ergo/) to conventional non-fungible tokens on platforms like Ethereum. Like so many areas of the Ergo ecosystem, the extended-UTXO model offers benefits and entirely new use cases.
