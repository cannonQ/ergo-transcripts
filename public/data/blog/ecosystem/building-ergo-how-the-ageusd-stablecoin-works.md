...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-02-05-building-ergo-how-the-ageusd-stablecoin-works
glossary_hits:
- Collateral
- Ergo Foundation
- Liquidation
...
> **Published:** 2021-02-05 | **Author:** Guy Brandon | **Tag:** Ecosystem | **Type:** blog

**Related concepts:** Collateral, Ergo Foundation, Liquidation, Native tokens, SigmaUSD
...
After launch, scheduled for mid-February, AgeUSD will be available via the [Sigmaverse](https://sigmaverse.io/), [Ergo’s dApp portal](https://ergoplatform.org/blog/2020-12-27-introducing-the-sigmaverse/). To find out more, read the documentation at <https://github.com/Emurgo/age-usd>.
