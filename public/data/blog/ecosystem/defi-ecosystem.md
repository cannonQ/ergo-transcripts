...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-05-10-defi-ecosystem
glossary_hits:
- AMM
- Atomic swaps
- Box
...
> **Published:** 2021-05-10 | **Author:** root7Z | **Tag:** Ecosystem | **Type:** blog

**Related concepts:** AMM, Atomic swaps, Box, Collateral, Ergo Explorer, ErgoScript, ErgoScript context, Layer scaling, Liquidation, Multi-stage contracts, Native tokens, NiPoPoW, Oracle pools, SigmaUSD, Spectrum, eUTXO
