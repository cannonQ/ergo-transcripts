...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-12-23-ergo-mining-tools-of-decentralization
glossary_hits:
- AMM
- Addresses
- Autolykos
...
> **Published:** 2021-12-23 | **Author:** Ergo Platform | **Tag:** Mining | **Type:** blog

**Related concepts:** AMM, Addresses, Autolykos, Bootstrapping, Box, ERGOHACK, ErgoMixer, Fair launch, NiPoPoW, Sigma protocols, Spectrum, Stealth Addresses, Storage rent, Transaction, eUTXO
...
ErgoDEX’s off-chain model led to some debates over the decentralization of the application. As Armeanio [explained here](https://ergoplatform.org/blog/2021-10-04-off-chain-logic-and-eutxo/), distributed off-chain bots will solve the problem of centralized nodes for the ErgoDEX. When people have incentives (such as DEX execution fees) to run the AMM bots, an increased number of users running the back-end of ErgoDEX is expected. A similar design can be applied to other DeFi applications on Ergo. 
