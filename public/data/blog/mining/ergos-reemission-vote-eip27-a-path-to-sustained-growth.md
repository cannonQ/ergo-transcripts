---
title: 'Ergo’s Reemission Vote EIP27: A Path to Sustained Growth?'
date: '2022-05-04'
...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/Ergos-Reemission-Vote-EIP27-A-Path-to-Sustained-Growth
glossary_hits:
- EIP
- Emission schedule
- Ergo Foundation
...
# Ergo’s Reemission Vote EIP27: A Path to Sustained Growth?

> **Published:** 2022-05-04 | **Author:** Ergo Platform | **Tag:** Mining | **Type:** blog

**Related concepts:** EIP, Emission schedule, Ergo Foundation, Fair launch, Native tokens, Storage rent, Transaction
...
- _“If block reward is not less than 15 ERG, send 12 ERG from it to the remission contract"._
- _"Otherwise, block reward R is less than 15 ERG, send R - 3 ERG from it to the remission contract.”_
