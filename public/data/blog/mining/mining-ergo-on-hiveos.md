...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2022-03-22-mining-ergo-on-hiveos
glossary_hits:
- Addresses
- Nautilus
- Registers
...
# Mining Ergo on HiveOS

> **Published:** 2022-03-22 | **Author:** Ergo Platform | **Tag:** Mining | **Type:** blog

**Related concepts:** Addresses, Nautilus, Registers

---

Have you ever wanted to mine Ergo but thought you might not have the technical knowledge? Surprisingly, it is not as inaccessible an activity as you might have thought. Whether you are a novice or experienced crypto miner, it is actually quite easy to mine Ergo. In our previous blog post, we offered steps on how to mine Ergo on Windows ([Mining Ergo on Windows](https://ergoplatform.org/blog/2022-03-17-mining-ergo-on-windows/)). With this article, we will guide readers through the steps of mining Ergo with the popular crypto mining operating system, HiveOS.
