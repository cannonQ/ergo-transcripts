...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2019_05_07_mining
glossary_hits:
- Autolykos
- Full node
---

# How to mine Ergo on Windows(x64)

> **Published:** 2019-05-07 | **Author:** Martin Spodymek | **Tag:** Mining | **Type:** blog

**Related concepts:** Autolykos, Full node
...
Before you can mine, you have to [configure your node](https://github.com/ergoplatform/ergo/wiki/Set-up-a-full-node), [wallet](https://ergoplatform.org/blog/2019_06_04_wallet-documentation/) and [miner](https://github.com/ergoplatform/ergo/wiki/Mining)
