...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2019_06_28_mainnet-bootstrap
glossary_hits:
- Addresses
- Autolykos
- Box
...
> **Published:** 2019-06-28 | **Author:** Ilya Oskin | **Tag:** Mining | **Type:** blog

**Related concepts:** Addresses, Autolykos, Box, Full node, Scorex
...
Build a [miner](https://github.com/ergoplatform/Autolykos-GPU-miner) according to its readme instruction (for Ubuntu) or using  [Windows manual](https://ergoplatform.org/blog/2019_05_07_mining).
