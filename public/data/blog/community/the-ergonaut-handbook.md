...
- transaction
category: blog
blog_tag: Community, Announcements
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-08-04-the-ergonaut-handbook
glossary_hits:
- Auction House
- Autolykos
- Box
...
# The Ergonaut Handbook

> **Published:** 2021-08-04 | **Author:** root7Z | **Tag:** Community, Announcements | **Type:** blog

**Related concepts:** Auction House, Autolykos, Box, Data input, ERGOHACK, Emission schedule, Ergo Foundation, ErgoMixer, ErgoScript, ErgoScript context, Full node, Multi-stage contracts, Native tokens, NiPoPoW, Oracle pools, Scorex, Sigma Chains, Sigma protocols, SigmaUSD, Spectrum, Storage rent, Token ID rule, Transaction
...
**Oracle Pools:** Oracles are the messengers of blockchain networks. They connect off-chain and on-chain data and create the backbone of DeFi systems. Ergo has an UTXO based approach to oracles with [oracle pools](https://ergoplatform.org/blog/2021-04-27-chainlink-oracles-vs-ergo-oracle-pools/) that will be cheaper and easier to access for decentralized information.
...
[Android Wallet](https://ergoplatform.org/blog/2021-07-29-ergo-for-android-released/) (a mobile wallet on [Google Play Store](https://play.google.com/store/apps/details?id=org.ergoplatform.android))

## Roadmap

Alex Chepurnoy’s [latest update](https://ergoplatform.org/blog/2021-07-13-updated-2021-roadmap-from-kushti/) offers insights into ongoing developments on the Ergo Platform.
...
After the overwhelming success of our very first hackathon, [ErgoHack](https://ergoplatform.org/blog/2021-06-19-ergohack/), we are pleased to announce that plans are underway to organize a second one very soon. 
...
<https://ergoplatform.org/discover/#Documents/>
