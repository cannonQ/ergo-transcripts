...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-08-17-ergo-advancing-on-bitcoin
glossary_hits:
- Box
- Data input
- ERGOHACK
...
# Ergo: Advancing on Bitcoin

> **Published:** 2021-08-17 | **Author:** Ergo Platform | **Tag:** Explaining Ergo | **Type:** blog

**Related concepts:** Box, Data input, ERGOHACK, ErgoScript, ErgoScript context, Multi-stage contracts, Native tokens, Transaction, eUTXO
...
Check our [GitHub](https://github.com/ergoplatform/ergo) and [Whitepapers](https://ergoplatform.org/discover/#Documents/) to get to know us and join our community on [Discord](https://discord.gg/kj7s7nb) and [Telegram](https://t.me/ergoplatform) to get in touch with the Core Team!
