...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-01-05-what-ergo-can-contribute-to-defi-interoperability
glossary_hits:
- Addresses
- Native tokens
- Sigma protocols
...
> **Published:** 2021-01-05 | **Author:** Guy Brandon | **Tag:** Explaining Ergo | **Type:** blog

**Related concepts:** Addresses, Native tokens, Sigma protocols, Transaction
...
The reality is quite different, as 2020 should have proven beyond doubt. New DeFi projects bring users and volume to each other; [composability is important](https://ergoplatform.org/blog/2020-12-18-2021-the-next-battlegrounds-for-defi/) because it allows dApps to provide reciprocal benefits and build mutual network effect. So why should the blockchain platforms themselves be any different?
...
Using [Ergo’s ZK Treasury](https://ergoplatform.org/blog/2020-09-04-announcing-the-zk-treasury-on-ergo/), an address is created with bespoke conditions. A team of seven people needs to create a digital signature to access the funds. Five of seven accounts need to sign a transaction, or else the CEO, CTO and CFO together.
