...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-01-20-how-ergo-makes-the-most-of-blockchain
glossary_hits:
- Addresses
- ErgoScript
- NiPoPoW
...
# How Ergo Makes the Most of Blockchain

> **Published:** 2021-01-20 | **Author:** Guy Brandon | **Tag:** Explaining Ergo | **Type:** blog

**Related concepts:** Addresses, ErgoScript, NiPoPoW, SPV, Sigma protocols, Storage rent, Transaction
...
* [Storage rent](https://ergoplatform.org/blog/2020_04_21_ergo_positioning/) is akin to ‘on-chain garbage collection’, reducing blockchain bloat and lowering the long-term costs of mining, improving economic sustainability.
* NiPoPoWs (non-interactive proof-of-proof-of-works) enable [mobile SPV clients](https://ergoplatform.org/blog/2020_05_1_spv_security/) and [even lite full nodes](https://ergoplatform.org/blog/2020_05_08_lite_full_nodes/), again reducing the barriers to maintaining the network and improving decentralisation.
...
* [Sigma Protocols](https://ergoplatform.org/blog/2020_03_16_ergo_sigma/), which allow for powerful cryptographic use cases, implemented elegantly and efficiently.
