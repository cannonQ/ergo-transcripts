...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-08-26-nipopow-applications-light-clients-and-side-chains
glossary_hits:
- Bootstrapping
- Collateral
- ERGOHACK
...
# NIPoPoW Applications: Light Clients and Side Chains

> **Published:** 2021-08-26 | **Author:** root7Z | **Tag:** Explaining Ergo | **Type:** blog

**Related concepts:** Bootstrapping, Collateral, ERGOHACK, Full node, NiPoPoW, SPV, Transaction
