...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-07-23-ergo-utxo-model-the-evolution-from-bitcoin-to-ergo
glossary_hits:
- Box
- Data input
- ErgoScript context
...
# Ergo UTXO Model: The Evolution From Bitcoin To Ergo

> **Published:** 2021-07-23 | **Author:** root7Z | **Tag:** Explaining Ergo | **Type:** blog

**Related concepts:** Box, Data input, ErgoScript context, Multi-stage contracts, NiPoPoW, Transaction, eUTXO
