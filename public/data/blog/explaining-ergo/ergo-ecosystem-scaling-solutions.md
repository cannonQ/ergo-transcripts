...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-10-29-ergo-ecosystem-scaling-solutions
glossary_hits:
- Bootstrapping
- Box
- ErgoScript
...
> **Published:** 2021-10-29 | **Author:** Ergo Platform | **Tag:** Explaining Ergo | **Type:** blog

**Related concepts:** Bootstrapping, Box, ErgoScript, Full node, Layer scaling, NiPoPoW, Sigma Chains, Soft fork, Storage rent, Transaction, eUTXO
...
Ergo utilizes "[Storage Rent Fee](https://ergoplatform.org/blog/2021-07-09-cryptocurrency-fees-a-solution-to-unreasonable-state-growth/)" to prevent spam and recirculate unused data bytes, known as dust. Storage Rent Fee helps to clean the network pollution and encourages users to be more active.
