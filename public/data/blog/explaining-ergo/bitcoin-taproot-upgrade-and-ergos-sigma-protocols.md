...
- transaction
category: blog
blog_tag: Explaining Ergo, Privacy
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-11-17-bitcoin-taproot-upgrade-and-ergos-sigma-protocols
glossary_hits:
- Atomic swaps
- Box
- ErgoScript
...
# Bitcoin Taproot Upgrade and Ergo’s Sigma Protocols

> **Published:** 2021-11-17 | **Author:** Ergo Platform | **Tag:** Explaining Ergo, Privacy | **Type:** blog

**Related concepts:** Atomic swaps, Box, ErgoScript, Layer scaling, NiPoPoW, Schnorr signatures, Sigma protocols, Transaction, eUTXO
