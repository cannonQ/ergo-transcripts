...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-04-08-heres-how-ergo-seeks-to-boost-interoperability-for-cardanos-eutxo-model
glossary_hits:
- Addresses
- Box
- Collateral
...
# Here’s how Ergo seeks to boost interoperability for Cardano’s eUTxO model 

> **Published:** 2021-04-08 | **Author:** Shiraz Jagati | **Tag:** Explaining Ergo | **Type:** blog

**Related concepts:** Addresses, Box, Collateral, ErgoScript context, Native tokens, Sigma protocols, Transaction, eUTXO
