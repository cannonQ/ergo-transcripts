...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2022-03-29-proof-of-work-energy-and-ergo
glossary_hits:
- Autolykos
- NiPoPoW
- Sigma protocols
...
> **Published:** 2022-03-29 | **Author:** Ergo Platform  | **Tag:** Explaining Ergo, Mining | **Type:** blog

**Related concepts:** Autolykos, NiPoPoW, Sigma protocols, Storage rent, Transaction, eUTXO
...
* [eUTXO](https://docs.ergoplatform.com/dev/protocol/eutxo/): Extended unspent transaction output eliminates the need to maintain blockchain state. It also allows for transaction [cost predictability](https://ergoplatform.org/blog/2022-02-09-ergos-hybrid-method-for-counting-costs/).
...
* [Storage Rent](https://ergoplatform.org/blog/2022-02-18-ergo-explainer-storage-rent/): Keeps coins in circulation, reduces the size of the chain and incentivizes miners by charging a small fee for storage every four years.
