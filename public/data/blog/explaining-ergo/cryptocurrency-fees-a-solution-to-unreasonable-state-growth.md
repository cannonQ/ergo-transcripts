...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-07-09-cryptocurrency-fees-a-solution-to-unreasonable-state-growth
glossary_hits:
- Addresses
- Box
- ErgoScript context
...
# Cryptocurrency Fees: A Solution to Unreasonable State Growth

> **Published:** 2021-07-09 | **Author:** root7Z | **Tag:** Explaining Ergo | **Type:** blog

**Related concepts:** Addresses, Box, ErgoScript context, Full node, Minimum transaction fee, Storage rent, Transaction
