...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-04-27-chainlink-oracles-vs-ergo-oracle-pools
glossary_hits:
- Box
- Collateral
- Multi-stage contracts
...
> **Published:** 2021-04-27 | **Author:** root7Z | **Tag:** Explaining Ergo, Ecosystem | **Type:** blog

**Related concepts:** Box, Collateral, Multi-stage contracts, Native tokens, Oracle pools, SigmaUSD, Transaction
...
<https://ergoplatform.org/blog/2020-11-09-first-steps-towards-interoperability-with-cardano-oracles/>
