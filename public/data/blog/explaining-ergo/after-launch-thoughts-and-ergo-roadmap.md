...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2019_07_09_after_launch
glossary_hits:
- Autolykos
- Box
- EIP
...
> **Published:** 2019-07-09 | **Author:** Alex Chepurnoy | **Tag:** Explaining Ergo | **Type:** blog

**Related concepts:** Autolykos, Box, EIP, Ergo Foundation, ErgoScript context, Full node, Native tokens, NiPoPoW, Ring signatures, SPV, Soft fork, Transaction
