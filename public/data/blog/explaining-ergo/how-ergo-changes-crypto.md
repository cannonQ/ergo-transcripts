...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-09-16-how-ergo-changes-crypto
glossary_hits:
- Autolykos
- Box
- Collateral
...
> **Published:** 2021-09-16 | **Author:** Ergo Foundation | **Tag:** Explaining Ergo | **Type:** blog

**Related concepts:** Autolykos, Box, Collateral, ErgoMixer, Fair launch, Multi-stage contracts, Native tokens, NiPoPoW, Oracle pools, SigmaUSD, Spectrum, Storage rent, Transaction, eUTXO
