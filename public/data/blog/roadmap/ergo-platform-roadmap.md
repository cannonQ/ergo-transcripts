...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2021-05-09-ergo-platform-roadmap
glossary_hits:
- EIP-12
- ErgoMixer
- Full node
...
# Ergo Platform Roadmap

> **Published:** 2021-05-09 | **Author:** Ergo Foundation | **Tag:** Roadmap | **Type:** blog

**Related concepts:** EIP-12, ErgoMixer, Full node, SigmaUSD, Spectrum

---

### Ergo Platform is boiling with updates! Recent updates are:

[Ledger integration](https://ergoplatform.org/blog/2021-05-07-ledger-network-integrates-ergo-network/) is announced in collaboration with [tesseract.one](tesseract.one)

[Wrap Assets](https://ergoplatform.org/blog/2021-04-21-wrapassets-announces-integration-with-ergodex/) announced integration with ErgoDEX Plutus Port for Cardano.
...
Native stable coin [SigmaUSD](https://ergoplatform.org/blog/2021_02_26-sigmausd-released/) is purchasable/redeemable on Ergo Blockchain.
...
Also check [The Ergo Manifesto](https://ergoplatform.org/blog/2021-04-26-the-ergo-manifesto/) and Ergo dApp marketplace [SigmaVerse](https://sigmaverse.io/) if you haven't check already. 
