...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2020_05_08_lite_full_nodes
glossary_hits:
- Box
- ErgoScript context
- Full node
...
> **Published:** 2020-05-08 | **Author:** Guy Brandon | **Tag:** Core | **Type:** blog

**Related concepts:** Box, ErgoScript context, Full node, NiPoPoW, SPV, Transaction
...
In a previous post, we looked at [Ergo’s SPV](https://ergoplatform.org/blog/2020_05_1_spv_security/) mode, which allows for secure, efficient mobile clients. This enables users to make transactions using almost any device. 
