...
type: blog
source: ergo-blog
source_url: https://ergoplatform.org/en/blog/2019_05_20-curve
glossary_hits:
- Autolykos
- Box
- Emission schedule
...
> **Published:** 2019-05-20 | **Author:** Justin Simpson | **Tag:** Core | **Type:** blog

**Related concepts:** Autolykos, Box, Emission schedule, Fair launch, Native tokens, Storage rent, Token ID rule, Transaction
